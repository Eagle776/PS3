...
settings.createBool('disableMyFavorites', 'Don\'t show My Favorites', false, function(v) {
  service.disableMyFavorites = false;
});
...
new page.Route(plugin.id + ':start', function(page) {
  ...
  showPlaylist(page);
    ...
    if (!service.disableSampleList) {
			page.model.contents = 'grid';
		var item = page.appendItem('m3u:m3u:http%3a%2f%2fbit.ly%2fJELZ1708:Premium', "directory", {
            title: 'Premium',
			icon: 'https://i.ibb.co/bWb2yNb/Play-Str3am.png'
        });
    }

    if (!service.disableSampleXMLList) {
			page.model.contents = 'grid';
        var item = page.appendItem('m3u:http%3a%2f%2fbit.ly%2fElSuacht:Gratis', "directory", {
            title: 'Gratis',
			icon: 'https://i.ibb.co/bWb2yNb/Play-Str3am.png'
        });
    }
